...
INSERT INTO `b_agent` VALUES (1,'main',100,'CEvent::CleanUpAgent();','Y','2018-03-01 19:46:28','2018-03-02 19:46:28',NULL,86400,'N',NULL,'N'),(2,'main',100,'CUser::CleanUpHitAuthAgent();','Y','2018-03-01 19:46:28','2018-03-02 19:46:28',NULL,86400,'N',NULL,'N'),(3,'main',100,'CCaptchaAgent::DeleteOldCaptcha(3600);','Y','2018-03-02 15:59:57','2018-03-02 16:59:57',NULL,3600,'N',NULL,'N'),(4,'main',100,'CUndo::CleanUpOld();','Y','2018-03-01 19:46:29','2018-03-02 19:46:29',NULL,86400,'N',NULL,'N'),(5,'main',100,'CUser::AuthActionsCleanUpAgent();','Y','2018-03-01 19:46:29','2018-03-02 19:46:29',NULL,86400,'N',NULL,'N'),(6,'main',100,'CSiteCheckerTest::CommonTest();','Y','2018-03-02 08:23:17','2018-03-03 08:23:17',NULL,86400,'N',NULL,'N'),(7,'main',100,'\\Bitrix\\Main\\Analytics\\CounterDataTable::submitData();','Y','2018-03-02 16:30:16','2018-03-02 16:31:16',NULL,60,'N',NULL,'N'),(8,'forum',100,'CForumStat::CleanUp();','Y','2018-03-01 19:46:29','2018-03-02 19:46:29',NULL,86400,'N',NULL,'N'),(9,'forum',100,'CForumFiles::CleanUp();','Y','2018-03-01 19:46:29','2018-03-02 19:46:29',NULL,86400,'N',NULL,'N'),(10,'search',10,'CSearchSuggest::CleanUpAgent();','Y','2018-03-01 19:46:31','2018-03-02 19:46:31',NULL,86400,'N',NULL,'N'),(11,'search',10,'CSearchStatistic::CleanUpAgent();','Y','2018-03-01 19:46:31','2018-03-02 19:46:31',NULL,86400,'N',NULL,'N'),(12,'security',100,'CSecuritySession::CleanUpAgent();','Y','2018-03-02 16:01:59','2018-03-02 16:31:59',NULL,1800,'N',NULL,'N'),(13,'security',100,'CSecurityIPRule::CleanUpAgent();','Y','2018-03-02 15:59:57','2018-03-02 16:59:57',NULL,3600,'N',NULL,'N'),(14,'seo',100,'Bitrix\\Seo\\Engine\\YandexDirect::updateAgent();','Y','2018-03-02 15:59:57','2018-03-02 16:59:57',NULL,3600,'N',NULL,'N'),(15,'seo',100,'Bitrix\\Seo\\Adv\\LogTable::clean();','Y','2018-03-01 19:46:30','2018-03-02 19:46:30',NULL,86400,'N',NULL,'N'),(16,'seo',100,'Bitrix\\Seo\\Adv\\Auto::checkQuantityAgent();','Y','2018-03-02 15:59:57','2018-03-02 16:59:57',NULL,3600,'N',NULL,'N'),(17,'subscribe',100,'CSubscription::CleanUp();','Y','2018-03-02 08:23:19','2018-03-03 03:00:00',NULL,86400,'Y',NULL,'N'),(28,'main',100,'CEventLog::CleanUpAgent();','Y','2018-03-02 11:23:01','2018-03-03 11:23:01',NULL,86400,'N',NULL,'N'),(69,'main',100,'\\Bitrix\\Main\\Data\\CacheEngineFiles::delayedDelete(1);','Y','2018-03-02 16:31:06','2018-03-02 00:00:01',NULL,1,'Y',NULL,'N');
...
INSERT INTO `b_group` VALUES (1,'2018-02-28 12:42:47','Y',1,'N','Администраторы','Полный доступ к управлению сайтом.',NULL,NULL),(2,'2018-02-28 12:42:47','Y',2,'Y','Все пользователи (в том числе неавторизованные)','Все пользователи, включая неавторизованных.',NULL,NULL),(3,'2018-02-28 12:42:47','Y',3,'N','Пользователи, имеющие право голосовать за рейтинг','В эту группу пользователи добавляются автоматически.',NULL,'RATING_VOTE'),(4,'2018-02-28 12:42:47','Y',4,'N','Пользователи имеющие право голосовать за авторитет','В эту группу пользователи добавляются автоматически.',NULL,'RATING_VOTE_AUTHORITY'),(5,'2018-02-28 12:49:01','Y',300,'N','Контент-редакторы',NULL,NULL,'content_editor'),(6,'2018-03-02 13:15:56','Y',100,'N','miniadmin','','a:0:{}','miniadmin');
...
INSERT INTO `b_user_access` VALUES (0,'group','G2'),(1,'group','G1'),(1,'group','G3'),(1,'group','G4'),(1,'group','G2'),(1,'user','U1'),(2,'user','U2'),(2,'group','G3'),(2,'group','G4'),(2,'group','G6'),(2,'group','G2');
...
-- Dump completed on 2018-03-02 16:32:34
