...
INSERT INTO `b_agent` VALUES (1,'main',100,'CEvent::CleanUpAgent();','Y','2018-03-05 08:08:30','2018-03-06 08:08:30',NULL,86400,'N',NULL,'N'),(2,'main',100,'CUser::CleanUpHitAuthAgent();','Y','2018-03-05 08:08:31','2018-03-06 08:08:31',NULL,86400,'N',NULL,'N'),(3,'main',100,'CCaptchaAgent::DeleteOldCaptcha(3600);','Y','2018-03-05 10:20:09','2018-03-05 11:20:09',NULL,3600,'N',NULL,'N'),(4,'main',100,'CUndo::CleanUpOld();','Y','2018-03-05 08:08:33','2018-03-06 08:08:33',NULL,86400,'N',NULL,'N'),(5,'main',100,'CUser::AuthActionsCleanUpAgent();','Y','2018-03-05 08:08:33','2018-03-06 08:08:33',NULL,86400,'N',NULL,'N'),(6,'main',100,'CSiteCheckerTest::CommonTest();','Y','2018-03-05 08:08:34','2018-03-06 08:08:34',NULL,86400,'N',NULL,'N'),(7,'main',100,'\\Bitrix\\Main\\Analytics\\CounterDataTable::submitData();','Y','2018-03-05 10:53:58','2018-03-05 10:54:58',NULL,60,'N',NULL,'N'),(8,'forum',100,'CForumStat::CleanUp();','Y','2018-03-05 08:08:35','2018-03-06 08:08:35',NULL,86400,'N',NULL,'N'),(9,'forum',100,'CForumFiles::CleanUp();','Y','2018-03-05 08:08:36','2018-03-06 08:08:36',NULL,86400,'N',NULL,'N'),(10,'search',10,'CSearchSuggest::CleanUpAgent();','Y','2018-03-05 08:08:39','2018-03-06 08:08:39',NULL,86400,'N',NULL,'N'),(11,'search',10,'CSearchStatistic::CleanUpAgent();','Y','2018-03-05 08:08:40','2018-03-06 08:08:40',NULL,86400,'N',NULL,'N'),(12,'security',100,'CSecuritySession::CleanUpAgent();','Y','2018-03-05 10:50:14','2018-03-05 11:20:14',NULL,1800,'N',NULL,'N'),(13,'security',100,'CSecurityIPRule::CleanUpAgent();','Y','2018-03-05 10:20:09','2018-03-05 11:20:09',NULL,3600,'N',NULL,'N'),(14,'seo',100,'Bitrix\\Seo\\Engine\\YandexDirect::updateAgent();','Y','2018-03-05 10:20:09','2018-03-05 11:20:09',NULL,3600,'N',NULL,'N'),(15,'seo',100,'Bitrix\\Seo\\Adv\\LogTable::clean();','Y','2018-03-05 08:08:37','2018-03-06 08:08:37',NULL,86400,'N',NULL,'N'),(16,'seo',100,'Bitrix\\Seo\\Adv\\Auto::checkQuantityAgent();','Y','2018-03-05 10:20:09','2018-03-05 11:20:09',NULL,3600,'N',NULL,'N'),(17,'subscribe',100,'CSubscription::CleanUp();','Y','2018-03-05 08:08:57','2018-03-06 03:00:00',NULL,86400,'Y',NULL,'N'),(28,'main',100,'CEventLog::CleanUpAgent();','Y','2018-03-05 08:08:38','2018-03-06 08:08:38',NULL,86400,'N',NULL,'N');
...
INSERT INTO `b_bitrixcloud_option` VALUES (1,'backup_quota',0,'0','0'),(2,'backup_total_size',0,'0','0'),(3,'backup_last_backup_time',0,'0','1519822392'),(4,'monitoring_expire_time',0,'0','1519996425');
...
INSERT INTO `b_group` VALUES (1,'2018-02-28 12:42:47','Y',1,'N','Администраторы','Полный доступ к управлению сайтом.',NULL,NULL),(2,'2018-03-05 05:49:29','Y',2,'Y','Все пользователи (в том числе неавторизованные)','Все пользователи, включая неавторизованных.','a:1:{s:14:\"LOGIN_ATTEMPTS\";s:1:\"1\";}',''),(3,'2018-02-28 12:42:47','Y',3,'N','Пользователи, имеющие право голосовать за рейтинг','В эту группу пользователи добавляются автоматически.',NULL,'RATING_VOTE'),(4,'2018-02-28 12:42:47','Y',4,'N','Пользователи имеющие право голосовать за авторитет','В эту группу пользователи добавляются автоматически.',NULL,'RATING_VOTE_AUTHORITY'),(5,'2018-02-28 12:49:01','Y',300,'N','Контент-редакторы',NULL,NULL,'content_editor'),(6,'2018-03-02 13:15:56','Y',100,'N','miniadmin','','a:0:{}','miniadmin');
...
INSERT INTO `b_module_group` VALUES (1,'main',5,'Q',NULL),(2,'fileman',6,'W',NULL),(3,'main',6,'Q',NULL),(5,'vote',6,'W',NULL);
...
INSERT INTO `b_user` VALUES (1,'2018-02-28 12:48:31','admin','4dCjoegHbaaf0a1f5c31085c3cda45fcfa19e290','p5cz9PCh35bfaee0689c6b87f8b9f63304405c57','Y','','','admin@ad.min','2018-03-05 08:32:27','2018-02-28 15:48:31',NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2018-02-28 15:48:31',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'2018-03-02 12:00:40','miniadmin','JQIpL0Er42dc6c86e2a7d60419ef28d458148c6e','3DOwSNvN8338c395395c9fb353e0e049aa01a127','Y','','','mini@ad.min','2018-03-05 08:50:18','2018-03-02 15:00:40','s1','','','','',NULL,NULL,'','','','','','','','','','0','','','','','','','','','','','','','','0','',NULL,'','',NULL,'',NULL,NULL,'2018-03-02 15:00:40','',NULL,0,NULL,'',NULL,NULL,'',NULL,'');
...
INSERT INTO `b_user_access` VALUES (0,'group','G2'),(1,'user','U1'),(2,'user','U2'),(1,'group','G1'),(1,'group','G3'),(1,'group','G4'),(1,'group','G2'),(2,'group','G3'),(2,'group','G4'),(2,'group','G6'),(2,'group','G2'),(1,'group','G1'),(1,'group','G3'),(1,'group','G4'),(1,'group','G2');
...
-- Dump completed on 2018-03-05 10:57:06
